...
cron "1 0 * * * " script-path=https://raw.githubusercontent.com/dompling/Script/master/jd/JD_extra_sign.js,tag=京东签到2
===================
【 QX  脚本配置 】 :
===================
...
try {
  ...
  const cookie1 = $.read(CookieJD);
  const cookie2 = $.read(CookieJD2);
  ...
  if (update) {
    $.write(JSON.stringify(cookies, null, "\t"), CacheKey);
  }
} catch (e) {
  $.log(e);
}
